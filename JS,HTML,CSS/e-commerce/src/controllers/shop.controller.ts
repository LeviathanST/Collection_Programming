...
import { ShopDto, removeShopDto, updateShopDto } from "src/dtos/shop.dto";
...
export class ShopController {
    ...
    @Delete()
    deleteShop(@Headers('Authorization') authToken: string, @Body() shopDetails: removeShopDto) {
        return this.shopService.deleteByShopID(authToken, shopDetails)
    }

    @Patch()
    updateShop(@Headers('Authorization') authToken: string, @Body() shopDetails: updateShopDto) {
        return this.shopService.updateShop(authToken, shopDetails);
    }
